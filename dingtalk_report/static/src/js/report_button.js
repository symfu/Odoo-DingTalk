odoo.define('dingtalk_report.oa_report_button', function (require) {
    "use strict";
        ...
        renderButtons: function ($node) {
            ...
            for(var i=0; i<show_button_model.length; i++) {
                if (tree_model == show_button_model[i]){
                    var button2 = $("<button type='button' class='btn btn-sm btn-default'>下载日志</button>")
