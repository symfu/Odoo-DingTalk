...
class GetDingtalkHrmDimissionList(models.TransientModel):
    ...
    emp_ids = fields.Many2many(comodel_name='hr.employee', relation='dingtalk_hrm_dimission_list_and_hr_employee_rel',
    ...
    def get_hrm_dimission_list(self):
        ...
        url = self.env['ali.dingtalk.system.conf'].search([('key', '=', 'hrm_listdimission')]).value
        ...
        try:
            ...
            if result.get('errcode') == 0:
                ...
                for res in result.get('result'):
                    ...
                    if emp:
                        hrm = self.env['dingtalk.hrm.dimission.list'].search([('emp_id', '=', emp[0].id)])
        ...
        action = self.env.ref('dingtalk_hrm.dingtalk_hrm_dimission_list_action')
